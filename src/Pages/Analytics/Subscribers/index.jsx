...
const index = () => {
    ...
    useEffect(() => {
        document.title = 'Subscribers | Bodify';
    }, []);
    ...
    return (
        ...
        >
            ...
            >
                <Typography variant='h4' sx={{ fontWeight: 700, color: '#2C2C2E' }}>Subscribers</Typography>
                <Box
                    sx={{
                        display: 'flex',
                        justifyContent: 'space-between',
            ...
            <BreakdownCard
                title={'Trainees'}
                logo={TraineeLogo}
                text={'Trainee Management'}
                link={'/trainee-management'}
            />
